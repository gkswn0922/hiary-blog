        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-group">
                <div class="sidebar-menu">
                    <!-- 대시보드 -->
                    <div class="menu-item">
                        <div class="menu-button active" @click="handleDashboardClick">
                            <div class="menu-icon">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="1.5">
            ...
            <div class="sidebar-group">
                <div class="sidebar-menu">
                    <!-- 게시물 (확장 가능) -->
                    <div class="menu-item">
                        <div class="menu-button collapsible" @click="togglePosts">
                            <div class="menu-icon">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="1.5">
                        ...
                        <div class="menu-button">
                            <div class="menu-icon">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="1.5">
                                    <path
                                        d="M8 21h12a2 2 0 0 0 2-2v-2H10v2a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v11a4 4 0 0 0 4 4Z" />
                                </svg>
                            </div>
...
const handleDashboardClick = () => {
    // 이미 대시보드 페이지에 있으므로 특별한 동작은 필요없음
